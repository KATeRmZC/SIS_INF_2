 ...
 * @author CORE i5
 */
public class ventanaProduc extends javax.swing.JPanel {

    /** Creates new form ventana_produc1 */
    public ventanaProduc() {
        initComponents();
    }
    ...
    private void pnlComprarMouseEntered(java.awt.event.MouseEvent evt) {                                        
        pnlComprar.setBackground(new Color(102,102,102));
    }                                       

    private void pnlComprarMouseExited(java.awt.event.MouseEvent evt) {                                       
